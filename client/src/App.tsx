...
function App() {
  ...
  const [dashboardDisplays, setDashboardDisplays] = useState<DigitalDisplay[]>(
    [],
  );
  return (
    <BrowserRouter>
      ...
      >
        ...
        <Routes>
          ...
          <Route
            path="/radioConfig"
            element={<RadioConfig radios={radios} setRadios={setRadios} />}
          />
          <Route
            path="/dataStructConfig"
            element={
              <DataStructConfig
                radios={radios}
                setRadios={setRadios}
